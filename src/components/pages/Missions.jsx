...
const Missions = () => {
    ...
    return (
        <div className='bg-black text-white'>
            ...
            <div className='flex gap-6 px-7 py-16'>
                <div className='w-1/2'>
                    <div className='text-8xl font-bold'>NASA Science Fleet Chart</div>
                    <div className='text-md font-medium py-3'>NASA Science missions circle the Earth, the Sun, the Moon, Mars, and many other destinations within our Solar System, including spacecraft that look out even further into our universe. The Science Fleet depicts the scope of NASA's activity and how all of the missions have permeated throughout the solar system.</div>
                    <a href="https://science.nasa.gov/wp-content/uploads/2023/05/smd-fleet-master-10-15-2023-1.jpg?w=1536&format=webp"  target="_blank"  rel="noopener noreferrer"><div className='text-xl flex font-bold'>Learn More   <img width="30" height="10" src="https://img.icons8.com/ios-filled/50/0061FF/circled-right-2.png" alt="circled-right-2" className='ml-2'/></div></a>
                </div>
                <div className='w-1/2'><img src={fleet} alt="" /></div>
